...
describe("DeckListCard component", () => {
  ...
  it("renders placeholder description and creator if not provided", () => {
    render(
      <MemoryRouter>
        <DeckListCard id={12} name="Simple Deck" formatName="Speed Duel" cardCount={20} />
      </MemoryRouter>,
    );
  ...
  it("renders select button and calls onSelect when clicked", () => {
    ...
    render(
      <MemoryRouter>
        <DeckListCard {...defaultProps} onSelect={handleSelect} />
      </MemoryRouter>,
    );
  ...
  it("navigates to deck page when container is clicked (when showActions is true)", () => {
    render(
      <MemoryRouter>
        <DeckListCard {...defaultProps} showActions={true} />
      </MemoryRouter>,
    );
  ...
  it("renders action buttons and calls onDelete when delete button is clicked", () => {
    ...
    render(
      <MemoryRouter>
        <DeckListCard {...defaultProps} showActions={true} onDelete={handleDelete} />
      </MemoryRouter>,
    );
