...
export function getCardTheme(typeString?: string): CardTheme {
  ...
  if (isSpell) {
    return {
      ...
      glowColor: "hover:shadow-glow-spell hover:border-emerald-500/40",
  ...
  if (isTrap) {
    return {
      ...
      glowColor: "hover:shadow-glow-trap hover:border-rose-500/40",
  ...
  if (isMonster) {
    return {
      ...
      glowColor: "hover:shadow-glow-monster hover:border-amber-500/40",
