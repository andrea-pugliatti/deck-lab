...
| `modules/database`       | `google_sql_database_instance` (PostgreSQL 18), `google_sql_database`, `google_sql_user`                                                                                                                                                                                                              | Managed PostgreSQL persistence (`POSTGRES_18`, `db-f1-micro`)                                                                            |
