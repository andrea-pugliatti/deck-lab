...
/**
 * JPA Attribute Converter mapping {@link CardRace} Enums to database character
 * strings.
 * 
 * <p>
 * <b>JPA Attribute Converter:</b>
 * Maps type-safe {@code CardRace} instances (like {@code DRAGON}) to database
 * strings (like "Dragon") and back, utilizing automatic Hibernate database
 * session hooks.
 * </p>
 */
...
public class CardRaceConverter implements AttributeConverter<CardRace, String> {
    ...
    /**
     * Converts a {@link CardRace} Java Enum value into its string column
