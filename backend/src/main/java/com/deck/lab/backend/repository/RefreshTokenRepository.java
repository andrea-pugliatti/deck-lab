 ...
 * 
 * <p>
 * <b>Modifying Queries & Transactions:</b>
 * Database write operations (like {@code #delete} or {@code update}) that are
 * custom-declared require <i>@Modifying</i> and <i>@Transactional</i>
 * annotations. <i>@Modifying</i> instructs Spring to execute the query as a
 * state-changing DML operation instead of a standard SELECT query, and
 * <i>@Transactional</i> binds the execution to a database transaction,
 * guaranteeing ACID safety.
 * </p>
 */
public interface RefreshTokenRepository extends JpaRepository<RefreshToken, Long> {
    ...
    /**
     * Resolves all active (non-revoked) tokens associated with a user, sorted by
     * creation date.
    ...
    /**
     * Custom delete query removing expired or manually revoked tokens from the
     * database.
     * Annotated with {@link org.springframework.data.jpa.repository.Modifying} to
