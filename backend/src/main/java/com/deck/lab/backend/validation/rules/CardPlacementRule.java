...
/**
 * Deck list construction rule validating that cards are housed in the correct
 * physical sections of the deck list.
 *
 * <p>
 * <strong>Concrete Rule Strategy (Constraint Placement Check)</strong>
 * </p>
 * <p>
 * Annotated with {@link Component} for autowired detection. In Yu-Gi-Oh!, card
 * classification types govern physical placement. For instance, Extra Deck
 * monsters (Fusion, Synchro, Xyz, Link) cannot be shuffled into the Main Deck.
 * Conversely, Main Deck cards (Spell, Trap, Normal/Effect monsters) must not
 * reside in the Extra Deck. This strategy inspects each card slot's
 * classification type and flags misplaced cards.
 * </p>
 */
@Component
