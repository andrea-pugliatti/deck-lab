...
/**
 * JPA Attribute Converter mapping {@link Format} Enums to database character strings.
 * 
 * <p>
 * <b>JPA Attribute Converter:</b> Maps type-safe {@code Format} instances (like {@code GOAT}) to
 * database strings (like "Goat") and back, utilizing automatic Hibernate database session hooks.
 * </p>
 */
...
public class FormatConverter implements AttributeConverter<Format, String> {
    ...
    /**
     * Converts a {@link Format} Java Enum value into its string column representation for SQL
     * storage.
     *
    ...
    /**
     * Converts a SQL string value read from the database back into a type-safe {@link Format} Enum.
     *
