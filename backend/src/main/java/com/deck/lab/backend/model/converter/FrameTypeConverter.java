...
/**
 * JPA Attribute Converter mapping {@link FrameType} Enums to database character
 * strings.
 * 
 * <p>
 * <b>JPA Attribute Converter:</b>
 * Databases usually store Enums as generic strings (e.g. "spell", "effect").
 * However, within Java we want type-safety. By implementing
 * {@link AttributeConverter} and marking it with
 * {@code @Converter(autoApply = true)}, Hibernate automatically intercepts
 * persistence writes/reads, converting Java {@code FrameType} instances into
 * database strings and vice versa, without requiring manual mapping on every
 * query.
 */
...
public class FrameTypeConverter implements AttributeConverter<FrameType, String> {
    ...
    /**
     * Converts a {@link FrameType} Java Enum value into its string column
