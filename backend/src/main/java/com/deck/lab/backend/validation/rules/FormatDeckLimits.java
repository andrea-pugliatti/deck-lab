 ...
 * </p>
 * <p>
 * This utility acts as a static registry mapping Yu-Gi-Oh! formats (e.g. Goat,
 * Speed Duel, TCG/OCG) to their respective {@link DeckSizeLimits} constraints.
 * It encapsulates the format ruleset lookup strategy, decoupling the rules
 * configuration map from the rule evaluation logic.
 * </p>
 */
public class FormatDeckLimits {
    ...
    private static final Map<Format, DeckSizeLimits> LIMITS_MAP = Map.of(
            ...
            Format.MASTER_DUEL, DEFAULT_LIMITS,
            Format.RUSH_DUEL, new DeckSizeLimits(40, 60, 15, 15));

    /**
     * Resolves the capacity bounds for the given format. Defaults to TCG/OCG
     * standard bounds (40-60 main, 15 extra, 15 side) if format is null or
     * unspecified.
     *
