 ...
 *
 * <p>
 * This config is activated only under the {@code ci} profile, replacing external AI network calls
 * with static JSON mock responses representing generated deck configurations and card suggestions.
 * </p>
 */
@Configuration
@Profile("ci")
public class MockAiConfig {
    ...
    /**
     * Creates and registers a mock {@link ChatModel} bean as the primary chat model.
     *
     * @return a mock ChatModel instance returning structured sample JSON configurations
     */
    @Bean
    @Primary
