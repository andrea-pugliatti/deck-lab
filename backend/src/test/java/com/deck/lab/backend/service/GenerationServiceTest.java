...
class GenerationServiceTest {
        ...
        void testGenerateDeck_FastPath() {
                ...
                DeckGenerateAiResponse parsed = new DeckGenerateAiResponse("AI Lightsworn", "Fast deck", List.of());
                ...
                List<DeckCardResponseDto> cardDtos = List.of(
                                new DeckCardResponseDto(1L, 15L, "Judgment Dragon", "Effect Monster", "Desc", "Dragon",
                                                "Light",
                                                "None", "url",
                                                "MAIN", 2));
        ...
        void testGenerateDeck_DescriptionTruncated() {
                ...
                DeckGenerateAiResponse parsed = new DeckGenerateAiResponse("AI Lightsworn", longDescription, List.of());
                when(responseParser.parseGenerationResponse(rawResponse)).thenReturn(parsed);
        ...
        void testGenerateDeck_WithRefinement() {
                ...
                when(promptBuilder.buildRefinementPrompt(eq(request), eq(draftResolved), eq(List.of("UnresolvedCard")),
                                eq(draftWarnings), any()))
                ...
                CardEntry refinedEntry = new CardEntry(
                                ...
                                "MAIN",
                                3);
                DeckGenerateAiResponse refinedParsed = new DeckGenerateAiResponse("AI Lightsworn Final", "Final deck",
                ...
                verify(promptBuilder).buildDraftPrompt(eq(request), any());
                verify(promptBuilder).buildRefinementPrompt(eq(request), eq(draftResolved),
