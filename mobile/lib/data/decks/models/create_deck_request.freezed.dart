...
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? description = null,Object? formatName = null,Object? deckCards = null,}) {
  return _then(CreateDeckRequest(
...
class _CreateDeckRequest implements CreateDeckRequest {
  const _CreateDeckRequest({required this.name, required this.description, required this.formatName, required  List<DeckCardResponse> deckCards}): _deckCards = deckCards;
