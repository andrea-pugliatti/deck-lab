...
/// The unique username identifier chosen by the user (min 3, max 50 characters).
 String get username;/// A valid email address matching user identity constraints.
 String get email;/// The password credentials chosen for registration (min 6, max 100 characters).
 String get password;
